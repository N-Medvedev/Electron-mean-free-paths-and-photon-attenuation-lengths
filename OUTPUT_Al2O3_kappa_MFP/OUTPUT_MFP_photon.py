...
df = pd.read_csv(r"OUTPUT_k-Al2O3_Photon_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7]
labels = [ "Al K-shell", "Al L1-shell", "Al L2-shell", "Al L3-shell", "O K-shell", "Valence", "Total"]
