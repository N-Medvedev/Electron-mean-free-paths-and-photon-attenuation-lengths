...
df = pd.read_csv(r"OUTPUT_SiC_Photon_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7]
labels = [ "Si K-shell", "Si L1-shell", "Si L2-shell", "Si L3-shell", "C K-shell", "Valence", "Total"]
