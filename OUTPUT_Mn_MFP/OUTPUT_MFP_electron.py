...
df = pd.read_csv(r"OUTPUT_Mn_Electron_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7, 8, 9]
labels = [ "Mn K-shell", "Mn L1-shell", "Mn L2-shell", "Mn L3-shell", "Mn M1-shell", "Mn M2-shell", "Mn M3-shell", "Valence", "Total inelastic"]
...
df2 = pd.read_csv(r"OUTPUT_Mn_Electron_EMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
columns_to_plot2 = [ 2]
labels2 = [ "Elastic"]
