...
df = pd.read_csv(r"OUTPUT_Nickel_Electron_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7, 8, 9]
labels = [ "Ni K-shell", "Ni L1-shell", "Ni L2-shell", "Ni L3-shell", "Ni M1-shell", "Ni M2-shell", "Ni M3-shell", "Valence", "Total inelastic"]
...
df2 = pd.read_csv(r"OUTPUT_Nickel_Electron_EMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
columns_to_plot2 = [ 2]
labels2 = [ "Elastic"]
