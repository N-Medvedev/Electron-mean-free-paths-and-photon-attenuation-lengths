...
df = pd.read_csv(r"OUTPUT_Cr_Pm3n_Electron_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7, 8, 9]
labels = [ "Cr K-shell", "Cr L1-shell", "Cr L2-shell", "Cr L3-shell", "Cr M1-shell", "Cr M2-shell", "Cr M3-shell", "Valence", "Total inelastic"]
...
df2 = pd.read_csv(r"OUTPUT_Cr_Pm3n_Electron_EMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
columns_to_plot2 = [ 2]
labels2 = [ "Elastic"]
