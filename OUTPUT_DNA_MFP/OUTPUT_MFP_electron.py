...
df = pd.read_csv(r"OUTPUT_DNA_Electron_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7, 8, 9]
labels = [ "C K-shell", "N K-shell", "O K-shell", "P K-shell", "P L1-shell", "P L2-shell", "P L3-shell", "Valence", "Total inelastic"]
...
df2 = pd.read_csv(r"OUTPUT_DNA_Electron_EMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
columns_to_plot2 = [ 6]
labels2 = [ "Elastic"]
