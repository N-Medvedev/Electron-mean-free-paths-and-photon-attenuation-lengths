...
df = pd.read_csv(r"OUTPUT_NaF_Photon_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7]
labels = [ "Na K-shell", "Na L1-shell", "Na L2-shell", "Na L3-shell", "F K-shell", "Valence", "Total"]
