...
df = pd.read_csv(r"OUTPUT_LiCl_Photon_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7]
labels = [ "Li K-shell", "Cl K-shell", "Cl L1-shell", "Cl L2-shell", "Cl L3-shell", "Valence", "Total"]
