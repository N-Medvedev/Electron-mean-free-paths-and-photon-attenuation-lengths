...
df = pd.read_csv(r"OUTPUT_Fe_Photon_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7, 8, 9]
labels = [ "Fe K-shell", "Fe L1-shell", "Fe L2-shell", "Fe L3-shell", "Fe M1-shell", "Fe M2-shell", "Fe M3-shell", "Valence", "Total"]
