...
df = pd.read_csv(r"OUTPUT_Ca_Electron_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7, 8, 9]
labels = [ "Ca K-shell", "Ca L1-shell", "Ca L2-shell", "Ca L3-shell", "Ca M1-shell", "Ca M2-shell", "Ca M3-shell", "Valence", "Total inelastic"]
...
df2 = pd.read_csv(r"OUTPUT_Ca_Electron_EMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
columns_to_plot2 = [ 2]
labels2 = [ "Elastic"]
