...
df = pd.read_csv(r"OUTPUT_Zn_Electron_IMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
plt.xscale("log")
plt.yscale("log")
# Prepare the plot:
columns_to_plot = [ 1, 2, 3, 4, 5, 6, 7, 8, 9]
labels = [ "Zn K-shell", "Zn L1-shell", "Zn L2-shell", "Zn L3-shell", "Zn M1-shell", "Zn M2-shell", "Zn M3-shell", "Valence", "Total inelastic"]
...
df2 = pd.read_csv(r"OUTPUT_Zn_Electron_EMFP.dat", sep=r'\s+', header=None, comment="#", skipinitialspace=True)
columns_to_plot2 = [ 2]
labels2 = [ "Elastic"]
